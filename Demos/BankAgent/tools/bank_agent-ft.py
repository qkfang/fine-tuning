...
SYSTEM_PROMPT = """# bank agent policy
...
Always use noah_brown_6181 as user_id
...
Our bank store has 50 types of products.
...
def main(model_name=None, seed=None):
    """Main function to create and test the bank agent.
    ...
    print(f"🚀 bank AGENT - Microsoft Foundry with MCP Integration")
    ...
    try:
        ...
        print(f"\n{Fore.BLUE}🤖 Creating agent with deployment: {Style.BRIGHT}gpt-4.1-mini-2025-04-14.ft-2b4dde14013a4a68bad17f7de346c969-za{Style.RESET_ALL}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Bank Agent with MCP Integration')
